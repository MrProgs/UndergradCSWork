...
*/
   ...
   public class Coin2WithCounters3AndHistoryTester {
      ...
      // Sean Daly's Additions: tests Coin2WithCounters3AndHistory
         System.out.println("Enter History Capacity:");
         int j = input.nextInt();
         Coin2WithCounters3AndHistory coinC = new Coin2WithCounters3AndHistory(j);
      ...
      // reports details of history
         ...
         int hotsytotsy = /*input.nextInt();*/7;
