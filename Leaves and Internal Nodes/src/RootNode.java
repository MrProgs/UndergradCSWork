...
import scranton.visual.JLine;
import scranton.visual.JOval;
import scranton.visual.VJFrame;

import java.io.*;
import scranton.visual.*;
import java.awt.*;
public class RootNode extends Component{
	...
	public RootNode(){
		...
		JLine branch = new JLine(row+5, col+19, row-135, col+59, border);
		JLine branch2 = new JLine(row+45, col+19, row+185, col+59, border);
		//V.add(node, 50);
		//V.add(branch, 50);
		//V.add(branch2, 50);
	}
